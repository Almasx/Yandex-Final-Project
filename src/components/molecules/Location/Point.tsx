...
const Point = ({ name, address }: IPointProps) => {
  return (
    <div className="flex flex-col">
      <p className="dark:text-primary-light font-medium">{name}</p>
      <p className="dark:text-primary-light flex items-center gap-1 opacity-30">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
