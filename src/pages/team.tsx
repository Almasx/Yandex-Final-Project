      ...
      <section className="relative col-span-full h-screen ">
        <div className="absolute h-full w-full scale-110">
          <div className="absolute inset-0 m-auto aspect-square h-5/6 object-cover">
            <svg fill="none" className="circle opacity-70 w-[85%] absolute top-[50%] translate-y-[-50%] h-[85%] translate-x-[-50%] left-[50%]" viewBox="0 0 479 477" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="sun">
              ...
              <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g opacity="0.7">
                  <path opacity="0.9" d="M5.03955 9.91162L4.63223 10.8767L23.9336 19.0233L24.3409 18.0583L5.03955 9.91162Z" className="dark:fill-[url(#paint2_linear_27_1118)] fill-[url(#paint0_linear_27_1118)]"/>
                  <path opacity="0.9" d="M10.8966 24.322L9.93148 23.9147L18.0781 4.61328L19.0432 5.02063L10.8966 24.322Z" className="dark:fill-[url(#paint3_linear_27_1118)] fill-[url(#paint1_linear_27_1118)]"/>
                  <path d="M14.8804 15.4383C15.4162 15.2205 15.6742 14.6094 15.4563 14.0735C15.2386 13.5375 14.6275 13.2796 14.0916 13.4974C13.5556 13.7152 13.2977 14.3262 13.5155 14.8622C13.7333 15.3982 14.3444 15.6561 14.8804 15.4383Z" className="dark:fill-white fill-black"/>
                  </g>
                  <defs>
                  <linearGradient id="paint0_linear_27_1118" x1="4.83572" y1="10.3945" x2="24.1369" y2="18.5411" gradientUnits="userSpaceOnUse">
                    <stop stop-opacity="0"/>
                    <stop offset="0.5" />
                    <stop offset="0.875" stop-color="#131313" stop-opacity="0.25"/>
                    <stop offset="1"  stop-opacity="0"/>
                  </linearGradient>
                  <linearGradient id="paint1_linear_27_1118" x1="10.414" y1="24.1183" x2="18.5607" y2="4.81695" gradientUnits="userSpaceOnUse">
                    <stop stop-opacity="0"/>
                    <stop offset="0.5" />
                    <stop offset="1"  stop-opacity="0"/>
                  </linearGradient>
                  <linearGradient id="paint2_linear_27_1118" x1="4.83572" y1="10.3945" x2="24.1369" y2="18.5411" gradientUnits="userSpaceOnUse">
                    <stop stop-opacity="0" stop-color="#fff"/>
                    <stop offset="0.5"  stop-color="#fff"/>
                    <stop offset="0.875" stop-color="#fff" stop-opacity="0.25"/>
                    <stop offset="1"  stop-color="#fff" stop-opacity="0"/>
                  </linearGradient>
                  <linearGradient id="paint3_linear_27_1118" x1="10.414" y1="24.1183" x2="18.5607" y2="4.81695" gradientUnits="userSpaceOnUse">
                    <stop stop-opacity="0" stop-color="#fff"/>
                    <stop offset="0.5"  stop-color="#fff"/>
                    <stop offset="1"  stop-color="#fff" stop-opacity="0"/>
                  </linearGradient>
            ...
            <svg fill="none" className="w-[65%] absolute top-[50%] translate-y-[-50%] h-[65%] translate-x-[-50%] left-[50%]" viewBox="0 0 479 477" xmlns="http://www.w3.org/2000/svg">
              <path d="M239.519 476.587C371.259 476.587 478.057 369.912 478.057 238.321C478.057 106.73 371.259 0.0539551 239.519 0.0539551C107.779 0.0539551 0.981445 106.73 0.981445 238.321C0.981445 369.912 107.779 476.587 239.519 476.587Z" fill="url(#linear_1)" fill-opacity="0.01"/>
              <path d="M477.557 238.321C477.557 369.635 370.984 476.087 239.519 476.087C108.055 476.087 1.48145 369.635 1.48145 238.321C1.48145 107.006 108.055 0.553955 239.519 0.553955C370.984 0.553955 477.557 107.006 477.557 238.321Z" className="stroke-[url(#linear_3)] dark:stroke-[url(#linear_2)]" stroke-opacity="0.36"/>
              <defs>
                <linearGradient id="linear_1" x1="239.519" y1="0.0539551" x2="240" y2="477" gradientUnits="userSpaceOnUse">
            ...
            <svg fill="none" className="circle-lg opacity-50 circle absolute top-[50%] translate-y-[-50%] translate-x-[-50%] left-[50%]" viewBox="0 0 479 477" xmlns="http://www.w3.org/2000/svg">
              <path d="M239.519 476.587C371.259 476.587 478.057 369.912 478.057 238.321C478.057 106.73 371.259 0.0539551 239.519 0.0539551C107.779 0.0539551 0.981445 106.73 0.981445 238.321C0.981445 369.912 107.779 476.587 239.519 476.587Z" fill="url(#linear_1)" fill-opacity="0.01"/>
              <path d="M477.557 238.321C477.557 369.635 370.984 476.087 239.519 476.087C108.055 476.087 1.48145 369.635 1.48145 238.321C1.48145 107.006 108.055 0.553955 239.519 0.553955C370.984 0.553955 477.557 107.006 477.557 238.321Z" className="stroke-[url(#linear_3)] dark:stroke-[url(#linear_2)]" stroke-opacity="0.36"/>
              <defs>
                <linearGradient id="linear_1" x1="239.519" y1="0.0539551" x2="240" y2="477" gradientUnits="userSpaceOnUse">
