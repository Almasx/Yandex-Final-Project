const Agreement = () => {
  return (
    <article className="col-span-full flex flex-col gap-4 p-12 text-lg">
      ...
      <h3 className="text-xl">1. Общие положения</h3>
      <p>
        1.1. Настоящая Политика конфиденциальности разработана{" "}
        <span className="font-medium">Особенный ТИП </span> (далее,
        соответственно – Политика и Оператор) для исполнения требований пункта 2
        части 1 статьи 18.1 Федерального закона от 27.07.2006 № 152-ФЗ «О
        персональных данных» (далее - Закон о персональных данных) и регулирует
        вопросы обработки Оператором персональных данных Пользователей Сайта.
      </p>
      <p>
      ...
      <p>
        ...
        <span className="font-medium">www.example.ru</span>;
      </p>
      <p>
      ...
      <ul className="flex list-inside list-none flex-col">
        <li>сбор;</li>
        <li>запись;</li>
      ...
      <h3 className="text-xl">2. Цели обработки персональных данных</h3>
      <p>
      ...
      <ul>
        <li className="pl-5 before:mr-1 before:content-['-']">
        ...
        <li className="pl-5 before:mr-1 before:content-['-']">фотографии.</li>
      </ul>
      <p>
      ...
      <p>
        ...
        электронному адресу:{" "}
        <span className="font-medium"> ostvolova@mail.ru</span>. Запрос
