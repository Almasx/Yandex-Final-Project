    ...
    return (
        <div className="container mx-auto">
            <div className="flex flex-col relative">
                ...
                <div className="w-100% h-[700px] flex flex-col items-center" id="map">
                    <ul className="w-[824px] h-[75px] rounded-2xl bg-dark-bg absolute bottom-8 mx-auto flex z-10 justify-between py-4 px-8">
